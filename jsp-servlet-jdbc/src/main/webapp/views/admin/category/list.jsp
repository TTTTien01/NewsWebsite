...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<c:url var="categoriesAPI" value="/api-admin-categories" />
...
<body>
	...
	<form action="<c:url value="/admin-categories" />" id="formSubmit" method="get">
	...
	<script type="text/javascript">
		...
		$('#btnDelete').click(function (e) {
			const isConfirmed = confirm('Bạn có chắc muốn xóa các thông tin danh mục này (thao tác này sẽ XÓA CÁC TIN TỨC liên quan đến danh mục này)?');
		...
		function deleteNew(data) {
	        $.ajax({
	            ...
	            success: function (result) {
	                window.location.href = "${categoriesList}?type=list&maxPageItems=5&page=1&message=delete_success";
	            },
